...
<html>
    ...
    <body>
        ...
        <div class="container">   
            ...
            <div class="jumbotron">
                <h1 >Edit Place</h1>
            <form action="/updateplace/{{ $place->id }}" method="POST" enctype="multipart/form-data"> 
                 {{ csrf_field() }}
                 {{ method_field('PUT')}}
                    <input type="hidden" name="id" id="id" value="{{ $place->id }}">
                    <div class="form-group">
                        <label>Name :</label>
                        <input type="text" name="name" value="{{ $place->name }}" class="form-control" placeholder="enter name">
                    </div>
        
                    <div class="form-group">
                        <label>City :</label>
                        <input type="text" name="city" value="{{ $place->city }}" class="form-control" placeholder="enter city">
                    </div>
        
                    <div class="form-group">
                        <label>Country :</label>
                        <input type="text" name="country" value="{{ $place->country }}" class="form-control" placeholder="enter country">
                    </div>
        
                    <div class="form-group">
                        <label>Descriptipn :</label>
                        <input type="text" name="description" value="{{ $place->description }}" class="form-control" placeholder="enter descriptipn">
                    </div>
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            ...
                            <input type="file" name="image" value="{{ $place->image }}" class="custom-file-input" >              
                        </div>
                    </div>
                    <br><br>
