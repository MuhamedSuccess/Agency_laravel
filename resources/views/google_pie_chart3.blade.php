<html>
  ...
  <script type="text/javascript">
    var analytics = <?php echo $user_type ; ?>
    ...
    function drawChart()
    {
     ...
     var options = {
      title : 'Percentage of Users Roles '
     };
 ...
 <body>
  ...
  <br />
  <div class="container">
   <h3 align="center"> Percentage of Users Roles </h3><br />
   
   <div class="panel panel-default">
    <div class="panel-heading">
     <h3 class="panel-title">Percentage of Users Roles</h3>
    </div>
