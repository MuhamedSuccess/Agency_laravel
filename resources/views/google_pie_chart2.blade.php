<html>
  ...
  <script type="text/javascript">
    var analytics = <?php echo $preferences; ?>
    ...
    function drawChart()
    {
     ...
     var options = {
      title : 'Percentage of user preferences'
     };
 ...
 <body>
  ...
  <br />
  <div class="container">
   <h3 align="center">Percentage of user preferences </h3><br />
   
   <div class="panel panel-default">
    <div class="panel-heading">
     <h3 class="panel-title">Percentage users preferences</h3>
    </div>
