...
<head>
    ...
    <link href="{{asset('create-trip/vendor/datepicker/daterangepicker.css')}}" rel="stylesheet" media="all">
...
<body>
    ...
    <!-- Jquery JS-->
    <script src="{{asset('create-trip/vendor/jquery/jquery.min.js')}}"></script>
    <!-- Vendor JS-->
